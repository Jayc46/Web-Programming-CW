...
//Sql query
$sql = "SELECT Country.ISO_id, Country.country_name, Country.bronze, Country.silver, Country.gold, Country.total, COUNT(Cyclist.ISO_id) AS \"Cyclist\", AVG(DATEDIFF('2012-01-01',Cyclist.dob)/365) AS \"Average_Age\" FROM Country LEFT JOIN Cyclist ON Cyclist.ISO_id = Country.ISO_id GROUP BY Country.ISO_id";

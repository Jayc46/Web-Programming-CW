...
if(isset($_POST['ISO_1'])){
  //Storing ISO_id values from user input in variable and values determined from jquery
  $ISO_1 = $_POST["ISO_1"];
  $ISO_2 = $_POST["ISO_2"];
  $total = $_POST["sort"];
  $order = $_POST["order"];
...
//Sql query
$sql="SELECT * FROM Country WHERE ISO_id = '$ISO_1' OR ISO_id = '$ISO_2' ORDER BY $total $order";
